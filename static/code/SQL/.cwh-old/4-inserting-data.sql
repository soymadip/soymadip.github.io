...
-- To insert data into a check table

INSERT INTO users VALUES
('1990-01-01', 1, 'HARRY@CD.COM', 'John Doe', 'Male', DEFAULT);

SELECT * FROM users;

-- But maintaining order is a drag.
--
-- ---------------------- So we use fields -------------------------
...
INSERT INTO users (name, email, gender, date_of_birth) VALUE 
    ( 'soymadip', 'sd@sd.com', 'Male', '2005-07-15'),
    ( 'sonaii', 'sd@gg.com', 'Female', '2004-09-27');
