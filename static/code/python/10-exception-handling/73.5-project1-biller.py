...
chai_shop.stock["masala"] += 5 # This doesnt actually call the setter. getter is called -> it gives reference to dict _stock, then python evaluates like dict updating.
