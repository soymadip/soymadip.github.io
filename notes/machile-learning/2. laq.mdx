...
- **Classification**: Classification is a supervised learning technique in Machine Learning that assigns data into predefined categories or classes.
- **Regression**: Regression is a supervised learning technique in Machine Learning used to predict continuous numerical values based on input data. (for example, predicting house prices based on features like size, location, and age)
...
## 10. What is 'ANN'. Perceptron. and its layers
...
## 11. What do you mean by Reinforcement learning?
...
## 12. Discuss Genetic Algorithm. How it is work?
...
## 15. What do you mean by forward Pass and Backward pass in Amr.
