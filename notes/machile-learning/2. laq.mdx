...
6. **Repeatation**: Steps 3 to 5 are repeated iteratively until the centroids stop moving, creating the final stabilized clusters..
...
In a shopping mall, customers can be grouped based on their purchasing behavior. Customers with similar buying habits belong to the same cluster.
 ...
 <big><u>**Types of Clustering**</u></big>
...
Check out [Question Number 6](#6-what-do-you-mean-by-clustering-types-of-clustering)
:::
