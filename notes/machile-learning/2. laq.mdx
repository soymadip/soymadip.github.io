...
- **Value function**: A function that estimates how good the current state is.
- **Reward**: Positive/Negative feedback received after performing an action.
...
<big>**Layers of Perceptron**</big>

<br />
<br />

![Perceptron Layers](./assets/layers-or-perception.webp)

<big>**1. Input Layer**</big>

First layer of the network.<br/>
...
Located between the input and output layers.<br/>
Performs calculations and extracts important features.
...
This is the final layer of the network.<br/>
This layer produces the result or prediction.
...
- It is often used as a stopping criteria for the algorithm.
