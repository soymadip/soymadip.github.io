...
- **When MC < AC:** The AC is **falling**. As long as the cost of producing an additional unit is less than the current average, it pulls the average down.
- **When MC = AC:** The AC is **constant and at its minimum**. This is the optimum efficiency point where the MC curve cuts the AC curve from below.
- **When MC > AC:** The AC is **rising**. Once the cost of the next unit exceeds the average, it pulls the average up.
...
- **Economic Profit** : Total income - (explicit cost + implicit cost)
