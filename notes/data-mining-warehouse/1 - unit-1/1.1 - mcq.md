...
### 4. **\_\_** is a subject-oriented, integrated, time-variant, non-volatile collection of data
...
### 10. **\_\_** describes the data in data warehouse

- **Answer: C. Metadata**
- **Support:** Metadata is “data about data,” defining the schema, structure, and meaning.

### 11. **\_\_** databases are owned by departments
...
### 15. Data can be updated in **\_\_** environment
