...
**Data Mining** is extracting useful, hidden **patterns** and knowledge from large datasets. It is the analysis step of KDD.
...
*Example: People who buy bread also buy butter (Bread $\rightarrow$ Butter).*

### 11. What are outliers?
Data points that are **significantly different** from the rest.
*Use Case: Used for **Fraud Detection**.*
