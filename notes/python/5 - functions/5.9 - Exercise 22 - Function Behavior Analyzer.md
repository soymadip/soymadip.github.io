...
You're building a tool to demonstrate different programming paradigms in Python. Implement a suite of functions that showcase purity, recursion, and higher-order patterns.
...
<details>
<summary>Only view the solution after trying your best</summary>
...
_Source file: [45.5-and-44.5-ex22.py](/code/python/5-functions/45.5-and-44.5-ex22.py)_
