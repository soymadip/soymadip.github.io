...
source_filename:
  - "47-importing-objects-or-functions/main.py"
  - "47-importing-objects-or-functions/utils/discounts.py"
  - "47-importing-objects-or-functions/recipies/flavours.py"
---
...
<SrcPv sources={[{ path: "/code/python/5-functions/47-importing-objects-or-functions/main.py", label: "main.py" }, { path: "/code/python/5-functions/47-importing-objects-or-functions/utils/discounts.py", label: "discounts.py" }, { path: "/code/python/5-functions/47-importing-objects-or-functions/recipies/flavours.py", label: "flavours.py" }]} />
