...
source_filename: "28.1-iterators.py"
---

# Iterators

In Python, an Iterator is an object that allows you to traverse through all elements of a collection, regardless of its implementation. It is the engine behind `for` loops, `map()`, `filter()`, and list comprehensions.
...
| :----------- | :-------------------------------------------------------- | :-------------------------------------- |
| **Iterable** | Any object you can loop over. It can produce an iterator. | `list`, `str`, `tuple`, `dict`          |
...
Iterators use **Lazy Evaluation**. They don't calculate or store all their values upfront. They only compute the "next" value when you explicitly ask for it. This allows for massive memory savings—you can iterate over a 10GB file or even an infinite sequence without crashing your RAM.
...
_Source file: [28.1-iterators.py](/code/python/4-loops/28.1-iterators.py)_
