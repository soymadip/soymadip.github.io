...
You’re creating a menu price lookup system for a food ordering app. You need to use the `match-case` statement to handle multiple menu items.
...
_Source file: [27.5 - Menu price lookup.py](../../../../src/code/python/3.%20conditionals/27.5%20-%20Menu%20price%20lookup.py)_
