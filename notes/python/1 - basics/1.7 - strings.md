...
Strings are **immutable**—you cannot change a character in place. If you're coming from C, you might be used to changing an array in place; in Python, you have to create a *new* string instead.
...
Don't use an index counter to look at every character. Python strings are iterable collections, so you can loop through them directly.
