...
<SrcPv sources={[{ path: "/code/python/7-generators-and-decoretors/52-generators.py", label: "52-generators.py" }, { path: "/code/python/7-generators-and-decoretors/53-infinite-generators.py", label: "53-infinite-generators.py" }]} />
